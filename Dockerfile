...
# Install Android SDK
RUN wget https://dl.google.com/android/android-sdk_r26.0.1-linux.tgz
RUN tar -xvzf android-sdk_r26.0.1-linux.tgz
RUN mv android-sdk-linux /usr/local/android-sdk
RUN rm android-sdk_r26.0.1-linux.tgz
...
ENV PROJECT /project RUN mkdir $PROJECT
